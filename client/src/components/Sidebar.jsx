...
const icons = {
  ...
  books: (
    <svg viewBox="0 0 24 24"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5A2.5 2.5 0 0 1 4 19.5z"/><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M8 2v20"/><path d="M12 6h4"/><path d="M12 10h4"/></svg>
  ),
  category: (
    <svg viewBox="0 0 24 24"><path d="M4 4h6l2 2h8v12H4V4z"/></svg>
  ),
  analytics: (
  ...
  loans: (
    <svg viewBox="0 0 24 24"><path d="M6 2h12l2 4v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6l2-4z"/><path d="M2 6h20"/><path d="M9 12h6"/><path d="M12 9v6"/></svg>
  ),
  chevronLeft: (
